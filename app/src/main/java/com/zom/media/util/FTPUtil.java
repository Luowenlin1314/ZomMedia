...
public class FTPUtil {
     ...
     *            password 密码
     */
    public FTPUtil(String host, String user, String pass) {
        this.hostName = host;
        this.userName = user;
        this.password = pass;
     ...
     * @throws IOException
     */
    public FtpResult download(String remotePath, String fileName, String localPath) throws IOException {
        boolean flag = true;
        FtpResult result = new FtpResult(false,0,0);
        // 初始化FTP当前目录
        ...
        for (FTPFile ftpFile : ftpFiles) {
            ...
            if (ftpFile.getName().equals(fileName)) {
                ...
                // 返回值
                result = new FtpResult(flag, endTime.getTime() - startTime.getTime(),response);
            }
        }
        return result;
    }
     ...
     * @throws IOException
     */
    public FtpResult uploading(File localFile, String remotePath) throws IOException {
        boolean flag = true;
